...
const features = [
  {
    ...
    description:
      'From idea to MVP in 28 days, not months. Our rapid development cycle helps you validate your concept quickly and gain a critical first-mover advantage that keeps you ahead in market.',
